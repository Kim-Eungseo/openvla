...
from experiments.robot.libero.run_libero_train_sac import LiberoGymWrapper
...
class EvalConfig:
    ...
    pretrained_checkpoint: Union[str, Path] = (
        "experiments/logs/SAC-libero_spatial-task0-2025_03_05-21_24_41_sac_model.zip"  # 저장된 SAC 모델 체크포인트 경로
    )
    ...
    resize_size: int = 128  # 이미지 전처리 해상도
    ...
    # WandB 로깅 옵션
    use_wandb: bool = False  # W&B 사용 여부
    wandb_project: str = "YOUR_WANDB_PROJECT"  # W&B 프로젝트 이름
    wandb_entity: str = "YOUR_WANDB_ENTITY"  # W&B 엔터티 이름
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        # required=True,
        default="experiments/logs/SAC-libero_spatial-task0-2025_03_05-21_24_41_sac_model.zip",
    ...
    parser.add_argument("--resize_size", type=int, default=128, help="이미지 전처리 해상도")
